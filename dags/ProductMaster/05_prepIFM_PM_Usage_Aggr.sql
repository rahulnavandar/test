CREATE OR REPLACE TABLE `{{ params.project }}.{{ params.environment }}_DWH_ProductMaster.ProductMaster_usageAggr`
AS
//usage-data-reporting.DEV
SELECT
usage.PMKey,
  usage.UsageItemDOI,
  ...
  b.BookPriceEUR
  FROM
`{{ params.project }}.{{ params.environment }}_DWH_Usage.ProductMaster_usageBK` usage
